...
const switcher = document.querySelectorAll(".switch"); // GET ALL THE SWITCHER
const addons = document.querySelectorAll(".box"); //GET ALL THE ADDONS
const total = document.querySelectorAll(".total b"); // GET THE TOTAL PRICE
const planPrice = document.querySelectorAll(".plan-price"); // GET PRICE OF THE SELECTED PLAN
let time;
let currentStep = 1;
let currentCircle = 0;
const obj = {
...
function showAddon(ad, val) {
    ...
    const servicePrice = clone.querySelector(".servic-price"); //service*??
